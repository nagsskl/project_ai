#application tracking system , this will show job matching percentage for Job description vs resume
# for start (venv) PS D:\ai-project\visual_path\project> streamlit run .\ATS.py 
